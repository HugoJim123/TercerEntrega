...
namespace MDI_Logistica
{
    public partial class MDI_Logistica : Form
    {
        ...
        {
            InterfazConsultaOrdenesDeCompra frm = new InterfazConsultaOrdenesDeCompra();
            frm.MdiParent = this;
            frm.Show();
            Application.DoEvents();
        }
        ...
        {
            InterfazConsultaOrdenesDeDevolucion frm = new InterfazConsultaOrdenesDeDevolucion();
            frm.MdiParent = this;
            frm.Show();
            Application.DoEvents();
        }
